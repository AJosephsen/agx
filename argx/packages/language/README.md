...
- [src/achitecture-graph.langium](src/achitecture-graph.langium) -  The grammar definition of your language
- [src/achitecture-graph-module.ts](src/achitecture-graph-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/achitecture-graph-validator.ts](src/achitecture-graph-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/achitecture-graph.monarch.ts](src/syntaxes/achitecture-graph.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/achitecture-graph.tmLanguage.json](syntaxes/achitecture-graph.tmLanguage.json) - Textmate based syntax highlighting instructions.
